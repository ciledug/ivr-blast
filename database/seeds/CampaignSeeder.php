...
class CampaignSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $demoCampaigns = array(
            [
                'name' => 'Demo Ready Campaign (Loans)',
                'status' => 0,
                'created_by' => 2,
                'template_id' => 1,
            ...
            [
                'name' => 'Demo Running Campaign (Credit Card)',
                'status' => 1,
                'created_by' => 2,
                'template_id' => 2,
            ...
            [
                'name' => 'Demo Finished Campaign (Currency)',
                'status' => 3,
                'created_by' => 2,
                'template_id' => 5,
        ...
        foreach ($demoCampaigns AS $keyDemo => $valDemo) {
            ...
            DB::table('campaigns')
                ->insert([
                    ...
                    'created_by' => $valDemo['created_by'],
                    'template_id' => $valDemo['template_id'],
                    'reference_table' => $valDemo['reference_table'],
                    'created_at' => $valDemo['created_at'],
                    'updated_at' => $valDemo['updated_at']
                ]);
